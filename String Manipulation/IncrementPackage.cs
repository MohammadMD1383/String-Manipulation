...
namespace String_Manipulation
{
	...
	public sealed class IncrementPackage : AsyncPackage
	{
		/// <summary>
		///     IncrementPackage GUID string.
		/// </summary>
		public const string PackageGuidString = "5ec4d8e1-ab84-4c38-a55b-aa11fcf70a3d";
		...
		protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
		{
			...
			await Increment.InitializeAsync(this);
			await Decrement.InitializeAsync(this);
		    await IncrementDuplicates.InitializeAsync(this);
		    await DecrementDuplicates.InitializeAsync(this);
		}
