...
{
	internal sealed class DecrementDuplicates
	{
		private const int CommandId = 0x0400;

		private static readonly Guid CommandSet = new Guid("d76396e3-c7ac-4e9a-bfd5-41bee2650ae4");

		private readonly AsyncPackage _package;

		private DecrementDuplicates(AsyncPackage package, OleMenuCommandService commandService)
		{
		...
		public static DecrementDuplicates Instance { get; private set; }
		...
		public static async Task InitializeAsync(AsyncPackage package)
		{
			...
			Instance = new DecrementDuplicates(package, commandService);
		}
